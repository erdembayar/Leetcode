...
public class BreadFirstTraversalBTRecursive {

	// Root of the Binary Tree
	NodeBT root;

	public BreadFirstTraversalBTRecursive() {
		root = null;
	}
	...
	/*
	 * Compute the "height" of a tree -- the number of NodeBTs along the longest
	 * path from the root NodeBT down to the farthest leaf NodeBT.
	 */
	...
	public static void main(String args[]) {
		BreadFirstTraversalBTRecursive tree = new BreadFirstTraversalBTRecursive();
